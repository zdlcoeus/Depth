...
BEGIN_MESSAGE_MAP(COpenCVTestDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTN_IMREAD, &COpenCVTestDlg::OnBnClickedBtnImread)
END_MESSAGE_MAP()
...
void COpenCVTestDlg::OnBnClickedBtnImread()
{
	// TODO: 在此添加控件通知处理程序代码
	
	cv::Mat image, image_gray;
	image = cv::imread("C:\\Users\\zdlco\\Pictures\\image.jpg");
